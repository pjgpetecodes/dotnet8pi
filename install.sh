...
echo ""
echo -e "Latest update 01/01/2024"
echo ""
...
echo -e "\e[0m"
echo -e "\e[1m---------------------------------------------------"
echo -e "\e[1m Installing .NET using the following home directory"
echo -e "\e[1m---------------------------------------------------"
echo -e "\e[0m"

echo -e "\e[1m$HOME\e[0m"
...
echo -e "\e[1m----------------------------------------"
echo -e "\e[0m"
echo "For the following Home Directory:"
echo ""
echo -e "\e[1m$HOME\e[0m"
echo ""
echo -e "\e[1m----------------------------------------"
...
wget -O $HOME/dotnetdebug.sh https://raw.githubusercontent.com/pjgpetecodes/dotnet8pi/main/dotnetdebug.sh
